...
Most jQuery applications don&rsquo;t in fact use XML, despite the name &ldquo;Ajax&rdquo;; instead, they transport data as plain HTML or JSON (JavaScript Object Notation).
